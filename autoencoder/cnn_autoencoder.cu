...
{   
    ...
    encoder_layer(dev_input, dev_pool_layer1, weights[0].weight, weights[0].bias, in_channels, out_channels, height, width);
    // - layer 2
    ...
    encoder_layer(dev_pool_layer1, dev_pool_layer2, weights[1].weight, weights[1].bias, in_channels, out_channels, layer1_out_height, layer1_out_width);
    //*****DECODER*****
    // - layer 3
    ...
    decoder_layer(dev_pool_layer2, dev_trans_layer3, weights[2].weight, weights[2].bias, in_channels, out_channels, layer2_out_height, layer2_out_width);
    // - layer 4
    ...
    decoder_layer(dev_trans_layer3, dev_trans_layer4, weights[3].weight, weights[3].bias, in_channels, out_channels, layer3_out_height, layer3_out_width);
    // - layer 5
    out_channels = weights[4].dim_0;
    in_channels = weights[4].dim_1;
    float *dev_result;
    cudaMalloc((void**)&dev_result, height * width * out_channels * sizeof(float));
    refine_layer(dev_trans_layer4, dev_result, weights[4].weight, weights[4].bias, in_channels, out_channels, layer4_out_height, layer4_out_width);
